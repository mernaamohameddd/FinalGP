...
<body>
  ...
  <main>
    ...
    <div className="about-me">
     ...
     <button className="Bbutton" onClick={Assignments3}> Start Taking Assignments</button>
    </div>
    <div className="about-me">
      <div className="about-me-text">
 ...
 <button className="Bbutton" onClick={Assignments}> Start Taking Assignments</button>      </div>
    <div className="about-me">
      <div className="about-me-text">
 ...
 <button className="Bbutton" onClick={Assignments2}> Start Taking Assignments</button>      </div>
  </main>
