  ...
  <main>
    ...
    <div className="about-me">
      <div className="about-me-text">
        <h2 style={{ textDecoration: 'underline' }}>Programming For Beginners</h2>
        <p>Programming 1</p>
        <div className="Bbutton"  style={{ fontWeight: 'bold', width: '150px', height:'50px', fontSize:'15px' }}>
        <a href="https://www.youtube.com/watch?v=AtVmk025uDY&list=PL1DUmTEdeA6IUD9Gt5rZlQfbZyAWXd-oD&pp=iAQB" target="_blank" rel="noopener noreferrer">
    ...
    <div className="about-me">
      <div className="about-me-text">
        <h2 style={{ textDecoration: 'underline' }}>Object Oriented Programming with C++</h2>
        <p>Programming 2</p>
        <div className="Bbutton"  style={{ fontWeight: 'bold', width: '150px', height:'50px', fontSize:'15px' }}>
        <a href="https://www.youtube.com/watch?v=H7pUHZrgscY&list=PL1DUmTEdeA6IUD9Gt5rZlQfbZyAWXd-oD&index=3&pp=iAQB" target="_blank" rel="noopener noreferrer">
      <button>Watch now!</button></a>
      </div>
      </div>
      <img  style={{ width: '300px', height: '300px', marginRight: '120px',marginLeft: '50px' }} src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/18/ISO_C%2B%2B_Logo.svg/1200px-ISO_C%2B%2B_Logo.svg.png" alt="me"></img>
