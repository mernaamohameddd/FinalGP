  ...
  <main>
    ...
    <div className="about-me">
      <div className="about-me-text">
        <h2 style={{ textDecoration: 'underline' }}>Object Oriented Programming with Java</h2>
        <p>Programming 1</p>
        <div className="Bbutton"  style={{ fontWeight: 'bold', width: '150px', height:'50px', fontSize:'15px' }}>
        <a href="https://www.youtube.com/watch?v=FbviMTJ_vP8&list=PL1DUmTEdeA6K7rdxKiWJq6JIxTvHalY8f&pp=iAQB" target="_blank" rel="noopener noreferrer">
    ...
    <div className="about-me">
      <div className="about-me-text">
        ...
        <p>Programming 2</p>
        <div className="Bbutton"  style={{ fontWeight: 'bold', width: '150px', height:'50px', fontSize:'15px' }}>
        <a href="https://www.youtube.com/watch?v=M3Na5luSx50&list=PL1DUmTEdeA6Icttz-O9C3RPRF8R8Px5vk&pp=iAQB" target="_blank" rel="noopener noreferrer">
      <button>Watch now!</button></a>
      </div>
      </div>
      <img src="https://logowik.com/content/uploads/images/731_java.jpg" alt="me"></img>
    ...
    <div className="about-me">
      <div className="about-me-text">
        <h2 style={{ textDecoration: 'underline' }}>Java Programming For Beginners</h2>
        <p>Programming 3</p>
        <div className="Bbutton"  style={{ fontWeight: 'bold', width: '150px', height:'50px', fontSize:'15px' }}>
        <a href="https://www.youtube.com/watch?v=FbviMTJ_vP8&list=PL1DUmTEdeA6K7rdxKiWJq6JIxTvHalY8f&pp=iAQB" target="_blank" rel="noopener noreferrer">
      <button>Watch now!</button></a>
    ...
    <div className="about-me">
      <div className="about-me-text">
        ...
        <p>Programming 4</p>
        <div className="Bbutton"  style={{ fontWeight: 'bold', width: '150px', height:'50px', fontSize:'15px' }}>
        <a href="https://www.youtube.com/watch?v=61X_kQUOvJ4&list=PLnzqK5HvcpwTgEDztQ8y4K4-VoeoK1QCG&pp=iAQB" target="_blank" rel="noopener noreferrer">
      <button>Watch now!</button></a>
      </div>
      </div>
      <img src="https://logowik.com/content/uploads/images/731_java.jpg" alt="me"></img>
