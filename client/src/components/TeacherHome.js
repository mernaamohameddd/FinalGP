  ...
  <main>
    ...
    <div className="achievements">
      ...
      <div className="work">
        ...
        <p className="work-heading" style={{ fontSize: '24px', fontWeight: '600' }}>Codes Submitted</p>
        <p className="work-text" style={{ fontSize: '20px' }}>Explore the code submissions from your students and gain valuable insights into their programming skills and understanding. Dive deep into their solutions, provide constructive feedback, and track their progress over time. Our platform offers a comprehensive overview of student submissions, empowering you to assess their comprehension, identify areas for improvement, and guide them towards mastery. Stay informed, provide guidance, and foster student growth with our intuitive interface designed to streamline the assessment process. Elevate your teaching experience and make a meaningful impact on your students' coding journey.</p>
        <div className="Bbutton"  style={{ fontWeight: 'bold' }}>
        <button onClick={ss}>View Student's Code</button>
      </div>
      </div>
    </div>
