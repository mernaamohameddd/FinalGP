  ...
  <main>
    ...
    <div className="about-me">
      <div className="about-me-text">
        ...
        <a href="https://www.udemy.com/course/java-the-complete-java-developer-course/" target="_blank" rel="noopener noreferrer">
    ...
    <div className="about-me">
      <div className="about-me-text">
        ...
        <p>Programming 2</p>
        <div className="Bbutton"  style={{ fontWeight: 'bold', width: '150px', height:'50px', fontSize:'15px' }}>
        <a href="https://www.udemy.com/course/java-se-programming/" target="_blank" rel="noopener noreferrer">
      <button>Enroll now!</button></a>
      </div>
      </div>
      <img src="https://logowik.com/content/uploads/images/731_java.jpg" alt="me"></img>
    ...
    <div className="about-me">
      <div className="about-me-text">
        ...
        <p>Programming 3</p>
        <div className="Bbutton"  style={{ fontWeight: 'bold', width: '150px', height:'50px', fontSize:'15px' }}>
        <a href="https://www.udemy.com/course/java-programming-tutorial-for-beginners/" target="_blank" rel="noopener noreferrer">
      <button>Enroll now!</button></a>
      </div>
      </div>
      <img src="https://logowik.com/content/uploads/images/731_java.jpg" alt="me"></img>
